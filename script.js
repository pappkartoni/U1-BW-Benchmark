...
function renderQuestion() {
    ...
    document.querySelector(".header").appendChild(baseTimer);
    renderTimer();
...
function renderResult(){
    ...
    rateUsBtn.onclick = renderFeedback;
}
...
// ----------------------------------------------------
// Starting the benchmark only if you accept the terms
// ----------------------------------------------------
...
function clickStar(event) {
    ...
    if (star.tagName === "path") {  //something about bubbling...
...
// ------------------------------------------------------
// Helper Functions for the Timer as well as the shuffle
// ------------------------------------------------------
